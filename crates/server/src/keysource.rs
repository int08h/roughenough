...
use keys::longterm::LongTermIdentity;
use keys::online::onlinekey::OnlineKey;
use keys::seed::SeedBackend;
use protocol::tags::{PublicKey, Version};
...
mod tests {
    ...
    fn zero_validity_duration_panics() {
        ...
        let version = protocol::tags::Version::RfcDraft14;
        let seed: Box<dyn keys::seed::SeedBackend> = Box::new(MemoryBackend::from_random());
