...
impl Default for RequestedVersions {
    fn default() -> Self {
        Self {
            versions: VersionList::new(&[ProtocolVersion::DRAFT_14]),
        }
    }
}
...
mod tests {
    ...
    fn wire_roundtrip() {
        let versions =
            RequestedVersions::new(&[ProtocolVersion::GOOGLE, ProtocolVersion::DRAFT_14]);
    ...
    fn default() {
        ...
        assert_eq!(versions.versions(), &[ProtocolVersion::DRAFT_14]);
    }
