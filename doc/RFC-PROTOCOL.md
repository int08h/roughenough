...
- Transport: the RFC allows UDP (single datagram) or TCP (multiple messages per connection); this implementation is UDP-only by design and declines the RFC's TCP SHOULDs
